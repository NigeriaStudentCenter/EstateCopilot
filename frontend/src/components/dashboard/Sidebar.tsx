...
export type NavView = 'Dashboard' | 'Properties' | 'Tenancies' | 'Tenant Vetting' | 'Finance & Levies' | 'Maintenance' | 'Legal' | 'Bookings' | 'Short Lets' | 'AI Inbox' | 'Settings';
...
const links: { name: NavView; icon: string }[] = [
  ...
  { name: 'Short Lets', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
